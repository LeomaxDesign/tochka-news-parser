...
INSERT INTO public.news_feeds (url, title, type, frequency, parse_count, item_tag, title_tag, description_tag, link_tag, published_tag, img_tag) VALUES ('https://news.yandex.ru/society.rss', 'https://news.yandex.ru/society.rss', 0, 10, 0, '', '', '', '', '', '');
INSERT INTO public.news_feeds (url, title, type, frequency, parse_count, item_tag, title_tag, description_tag, link_tag, published_tag, img_tag) VALUES ('https://news.yandex.ru/politics.rss', 'https://news.yandex.ru/politics.rss', 0, 60, 0, '', '', '', '', '', '');
--
