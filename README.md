...
У пользователя есть возиможность просматривать список новостей из базы и искать их по подстроке в заголовке новости.
...
## /feed/add - POST (на входе ссылка и правила) {link, parsingRules{count}}
## /news/ - GET (получение новостей)
## /news?title={} - GET (получение новостей по подстроке в заголовке)
